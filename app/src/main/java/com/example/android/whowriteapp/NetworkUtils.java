...
public class NetworkUtils {
    ...
    private static final String MAX_RESULTS ="maxResult"; //Parameter that limits search results
    ...
    try {
        ...
        while ((line = reader.readLine()) != null) {
            /*Since it's JSON, aading a newline isn'y necessary (it won't affect parsing) but it does make debugging a *loy* easier if you print out the completed buffer for debugging.)*/
            buffer.append(line + "\n");
        }
        if (buffer.length() == 0) {
        //Stream was emptu. No point in parsing.
        return null;
        }
